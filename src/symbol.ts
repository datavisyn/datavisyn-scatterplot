...
export class SymbolUtils {
   ...
   */
  static d3Symbol(symbol: SymbolType = SymbolUtils.d3SymbolCircle, fillStyle: string = 'steelblue', size = 5): ISymbol<any> {
  ...
  static readonly defaultOptions: Readonly<ISymbolOptions> = Object.assign({
    symbolSize: 20
  ...
  static circleSymbol(params?: Partial<ISymbolOptions>): ISymbol<any> {
    const options: ISymbolOptions = Object.assign({}, SymbolUtils.defaultOptions, params || {});
  ...
  static readonly defaultLineOptions: Readonly<ILineSymbolOptions> = Object.assign({
    lineWidth: 1,
    curve: null
  }, SymbolUtils.defaultStyleOptions);
  ...
  static lineRenderer(params?: Partial<ILineSymbolOptions>) {
    const options: ILineSymbolOptions = Object.assign({}, SymbolUtils.defaultLineOptions, params || {});
