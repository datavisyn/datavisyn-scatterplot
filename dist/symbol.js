...
export class SymbolUtils {
    ...
    static circleSymbol(params) {
        const options = Object.assign({}, SymbolUtils.defaultOptions, params || {});
    ...
    static lineRenderer(params) {
        const options = Object.assign({}, SymbolUtils.defaultLineOptions, params || {});
        const styles = {
            [ERenderMode.NORMAL]: options.fillColor,
            [ERenderMode.HOVER]: options.hoverColor,
            [ERenderMode.SELECTED]: options.selectedColor
...
SymbolUtils.defaultOptions = Object.assign({
    symbolSize: 20
}, SymbolUtils.defaultStyleOptions);
SymbolUtils.defaultLineOptions = Object.assign({
    lineWidth: 1,
    curve: null
}, SymbolUtils.defaultStyleOptions);
